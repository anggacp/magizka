...
class DetailProgramWasting_PMTFragment: Fragment() {

    private var _binding: DetailProgramWastingPmtBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = DetailProgramWastingPmtBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
